            ...
            <div class="pure-card rounded-custom card-bg shadow-custom">
                <div class="pure-card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.departments.create') }}" class="btn btn-primary btn-sm" wire:navigate>Tạo mới</a>
                    </div>
                </div>
                        ...
                        <table class="table text-nowrap align-middle table-hover">
                            ...
                            <tbody>
                                ...
                                <tr wire:key="dept-{{ $dept->id }}">
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('admin.departments.edit', $dept) }}" class="btn btn-sm btn-icon btn-light text-primary rounded-pill me-1" title="Sửa" wire:navigate>
