                                ...
                                <tr wire:key="dept-{{ $dept->id }}">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar bg-light-info text-info rounded me-3 d-flex align-items-center justify-content-center icon-36" >
                                    ...
                                    <td>
                                        <div class="form-check form-switch m-0 border-0">
                                            <input class="form-check-input" type="checkbox" wire:click="toggleActive({{ $dept->id }})" {{ $dept->is_active ? 'checked' : '' }} class="cursor-pointer">
                                        </div>
                                    </td>
                                    @canany(['departments.edit', 'departments.delete'])
                                    <td class="text-end">
