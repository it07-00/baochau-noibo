                                            ...
                                            <div class="p-3 bg-body-tertiary border rounded-3">
                                                <div class="row g-2">
                                                        ...
                                                        <div class="col-md-4 col-sm-6">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                       value="{{ $presetService }}"
                                                                       id="service_preset_{{ $loop->index }}"
                                                                       wire:model.live="selectedServices">
                                                                <label class="form-check-label small user-select-none" for="service_preset_{{ $loop->index }}">
                                                                    {{ $presetService }}
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                   id="service_preset_custom"
                                                                   wire:model.live="hasCustomService">
                                                            <label class="form-check-label small user-select-none fw-semibold text-primary" for="service_preset_custom">
                                                ...
                                                @if($hasCustomService)
                                                    <div class="mt-2 pt-2 border-top">
                                                        <label class="form-label small text-muted mb-1" for="custom_service_input">Nội dung dịch vụ khác / bổ sung</label>
                                                        <input type="text" id="custom_service_input" class="form-control form-control-sm"
