...
<div class="dept-race-board"
     x-data="{ mode: document.documentElement.getAttribute('data-bs-theme') || 'dark' }"
     :class="{ 'dept-mode-light': mode === 'light' }"
     x-init="
         const observer = new MutationObserver(() => {
             mode = document.documentElement.getAttribute('data-bs-theme') || 'dark';
         });
    ...
    <div class="dept-wrapper">
        ...
        {{-- FILTERS --}}
        <div class="dept-filters d-flex align-items-center flex-wrap gap-3 mb-4">
