<div>
        ...
        <div class="card-body py-3 px-4">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-5 col-lg-4">
                    <div class=" text-muted mb-1">So sánh năm trước</div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class=" text-muted fw-semibold mb-2">{{ $card['label'] }}</div>
                    <div class="fw-bold fs-4 text-{{ $card['color'] }}">{{ number_format($card['current'], 0, ',', '.') }} đ</div>
                    <div class=" mt-2 text-muted d-flex justify-content-between align-items-center gap-2">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body py-3 px-4 d-flex justify-content-between align-items-center">
            <div>
                <div class=" text-muted fw-semibold">Chênh lệch tổng năm</div>
                    ...
                    <tbody>
                        @foreach($quarters as $q => $data)
                            ...
                            <tr class="{{ $qTotal == 0 ? 'table-light' : '' }}">
                                <td class="fw-semibold">Quý {{ $q }} <span class="text-muted ">(T{{ ($q - 1) * 3 + 1 }}-T{{ $q * 3 }})</span></td>
                                ...
                                <td>
                                    @if($qPct !== null)
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class=" fw-semibold text-primary" style="min-width:46px; text-align:right;">{{ $qPct }}%</span>
                                        </div>
                                    @else
                                        <span class="text-muted ">—</span>
                                    @endif
