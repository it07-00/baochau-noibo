<div>
    <div class="page-header d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-0">Bảng theo dõi đo mẫu</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('app.dashboard') }}">Bảng điều khiển</a></li>
                    <li class="breadcrumb-item active">Theo dõi đo mẫu quan trắc</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <div class="fw-bold fs-4 text-primary">{{ $summary->count ?? 0 }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body py-3">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label fw-semibold mb-1 small">Tư vấn viên / NV</label>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->consultant?->name ?? $item->staff?->name ?? '—' }}</td>
