    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body py-3">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label fw-semibold mb-1 small">Khách hàng</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select wire:model="form.contract_waste_id" class="form-select form-select-sm">
                                ...
                                @foreach($contractWastes as $cw)
                                    <option value="{{ $cw->id }}">{{ $cw->shd_ad ?: 'HĐ #'.$cw->id }} — {{ $cw->customer?->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small">Đã thu (đ)</label>
