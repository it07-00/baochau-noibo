<tr>
    <th class="bg-body-tertiary text-body">Phương thức thanh toán</th>
    <td>
...
<tr>
    <th class="bg-body-tertiary text-body">% thanh toán</th>
    <td class="fw-semibold">{{ number_format((float) ($selectedDoc->payment_percentage ?? 100), 2, ',', '.') }}%</td>
</tr>
<tr>
    <th class="bg-body-tertiary text-body">Nội dung dịch vụ</th>
    <td class="text-pre-wrap">{{ $selectedDoc->service_content ?: '—' }}</td>
</tr>
<tr>
    <th class="bg-body-tertiary text-body">Nơi nộp</th>
