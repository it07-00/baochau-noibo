                                ...
                                <td class="text-center">
                                    ...
                                    <div class="mt-2">
                                        <div class="progress h-6px w-80px mx-auto">
                                            <div class="progress-bar bg-{{ $this->workflowProgressMeta($doc)['progressColor'] }}"
                                                style="width: {{ $this->workflowProgressMeta($doc)['progressPercent'] }}%"></div>
                                        </div>
                                        <span
                                            class="fw-semibold text-{{ $this->workflowProgressMeta($doc)['progressColor'] }} contract-text-08">{{ $this->workflowProgressMeta($doc)['completedSteps'] }}/{{ $this->workflowProgressMeta($doc)['totalSteps'] }}</span>
                                    </div>
                                </td>
                                <td class="text-center">
                                    @if ($this->deadlineMeta($doc)['deadline'])
                                        @if ($this->deadlineMeta($doc)['isFinished'])
                                            <span
                                                class="fw-semibold text-success contract-text-08">{{ $this->deadlineMeta($doc)['deadline']->format('d/m/Y') }}</span>
                                        ...
                                        @elseif($this->deadlineMeta($doc)['isOverdue'])
                                            <span
                                                class="fw-bold text-danger contract-text-08">{{ $this->deadlineMeta($doc)['deadline']->format('d/m/Y') }}</span>
                                            <br><span class="badge bg-danger contract-text-08"><i
                                                    class="fa-solid fa-triangle-exclamation me-1"></i>Quá hạn
                                                {{ abs($this->deadlineMeta($doc)['daysLeft']) }} ngày</span>
                                        @elseif($this->deadlineMeta($doc)['isNearDue'])
                                            <span
                                                class="fw-semibold text-warning contract-text-08">{{ $this->deadlineMeta($doc)['deadline']->format('d/m/Y') }}</span>
                                            <br><span class="badge bg-warning text-dark contract-text-08"><i
                                                    class="fa-solid fa-clock me-1"></i>Còn {{ $this->deadlineMeta($doc)['daysLeft'] }} ngày</span>
                                        @else
                                            <span
                                                class="fw-semibold text-success contract-text-08">{{ $this->deadlineMeta($doc)['deadline']->format('d/m/Y') }}</span>
                                            <br><span class="badge bg-success bg-opacity-75 contract-text-08">Còn
                                                {{ $this->deadlineMeta($doc)['daysLeft'] }} ngày</span>
                                        @endif
                                    @else
                                        <span class="text-muted">—</span>
                                    @endif
                                                            ...
                                                            <div class="mb-1">
                                                                ...
                                                                @if ($assign->deadline)
                                                                    <br><small class="text-warning fw-semibold"><i
                                                                            class="fa-solid fa-calendar-day me-1"></i>Hạn:
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="d-flex align-items-center gap-2">
                                <span class="fw-semibold text-primary small text-uppercase"
                                    style="white-space:nowrap"><i class="fa-solid fa-file-text me-1"></i>Thông tin
                                    hợp đồng</span>
                        ...
                        <div class="col-12 mt-2">
                            <div class="d-flex align-items-center gap-2">
                                <span class="fw-semibold text-primary small text-uppercase"
                                    style="white-space:nowrap"><i class="fa-solid fa-calendar-days me-1"></i>Thời hạn</span>
                                <hr class="flex-fill my-0 border-primary border-opacity-25">
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12 mt-2">
                            <div class="d-flex align-items-center gap-2">
                                <span class="fw-semibold text-primary small text-uppercase"
                                    style="white-space:nowrap"><i class="fa-solid fa-coins me-1"></i>Tài chính</span>
                                <hr class="flex-fill my-0 border-primary border-opacity-25">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-2">
                            <div class="d-flex align-items-center gap-2">
                                <span class="fw-semibold text-primary small text-uppercase"
                                    style="white-space:nowrap"><i class="fa-solid fa-tags me-1"></i>Phân loại & Trạng
                                    thái</span>
                                <hr class="flex-fill my-0 border-primary border-opacity-25">
                            </div>
                        </div>
