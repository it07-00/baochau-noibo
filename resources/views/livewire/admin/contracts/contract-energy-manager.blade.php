                ...
                <tbody>
                    ...
                    <tr class="border-bottom border-light">
                        ...
                        <td style="max-width:200px;">
                            <span class="badge bg-warning-subtle text-warning border border-warning-subtle small d-inline-block text-truncate" style="max-width:190px;" title="{{ $doc->loai_dich_vu }}">{{ $doc->loai_dich_vu ?: '-' }}</span>
                        </td>
                        @unless(auth()->user()->hasAnyRole(['tu-van', 'ky-thuat']))
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-4">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="form_en_renewal" wire:model="formData.is_renewal">
