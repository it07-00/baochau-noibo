<div>
    ...
    @php
        $canBulkDelete = auth()->user()->can('contracts-energy.delete') && !auth()->user()->hasAnyRole(['tu-van', 'ky-thuat']);
    @endphp
                    ...
                    @forelse($docs as $doc)
                        <tr class="border-bottom border-light">
                            ...
                            <td style="max-width:200px;">
                                <span
                                    class="badge bg-warning-subtle text-warning border border-warning-subtle small d-inline-block text-truncate"
                ...
                <div class="modal-body p-0">
                    @if ($selectedDoc)
                        ...
                        <ul class="nav nav-tabs px-4 pt-3 bg-white" role="tablist">
                            <li class="nav-item">
                                <button class="nav-link active fw-semibold" data-bs-toggle="tab"
                                    data-bs-target="#tab-info-energy-{{ $selectedDoc->id }}" type="button">
                                    <i class="bi bi-info-circle me-1"></i>Thông tin HĐ
                                </button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link fw-semibold" data-bs-toggle="tab"
                                    data-bs-target="#tab-progress-energy-{{ $selectedDoc->id }}" type="button">
                        ...
                        <div class="tab-content">
                            {{-- Tab 1: Thông tin HĐ --}}
                            <div class="tab-pane fade show active" id="tab-info-energy-{{ $selectedDoc->id }}"
                                role="tabpanel">
                            ...
                            {{-- Tab 2: Tiến độ --}}
                            <div class="tab-pane fade" id="tab-progress-energy-{{ $selectedDoc->id }}"
                                role="tabpanel">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" wire:model="formData.province"
                                list="province-list-energy" autocomplete="off">
