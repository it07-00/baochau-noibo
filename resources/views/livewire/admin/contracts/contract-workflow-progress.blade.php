<div class="px-4 py-3 border-top" style="background: #f8f9fa;">
    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <span class="badge bg-primary bg-opacity-10 text-primary border border-primary-subtle" style="font-size: 0.75rem;">
    ...
    <div class="d-flex align-items-start" style="gap: 0;">
        ...
        <div class="d-flex align-items-center flex-grow-1">
            <div class="d-flex flex-column align-items-center flex-shrink-0" style="width: 62px;">
                ...
                <span class="text-center" style="font-size: 0.62rem; line-height: 1.2; width: 62px; word-break: break-word;
            ...
            @if(!$loop->last)
            <div class="flex-grow-1" style="height: 2px; margin-top: -18px; min-width: 6px;
