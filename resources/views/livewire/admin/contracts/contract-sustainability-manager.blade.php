            ...
            <div class="modal-content overflow-hidden border-0 shadow-lg">
                ...
                <div class="modal-body p-0">
                    ...
                    <ul class="nav nav-tabs px-4 pt-3 bg-white" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link active fw-semibold" data-bs-toggle="tab" data-bs-target="#tab-info-sustainability-{{ $selectedDoc->id }}" type="button">
                                <i class="bi bi-info-circle me-1"></i>Thông tin HĐ
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link fw-semibold" data-bs-toggle="tab" data-bs-target="#tab-progress-sustainability-{{ $selectedDoc->id }}" type="button">
                                <i class="bi bi-diagram-3 me-1"></i>Tiến độ hoàn thành
                            </button>
                        </li>
                        @unless(auth()->user()->hasAnyRole(['tu-van', 'ky-thuat']))
                        <li class="nav-item">
                            <button class="nav-link fw-semibold" data-bs-toggle="tab" data-bs-target="#tab-payment-sustainability-{{ $selectedDoc->id }}" type="button">
                    ...
                    {{-- Tab 1: Thông tin HĐ --}}
                    <div class="tab-pane fade show active" id="tab-info-sustainability-{{ $selectedDoc->id }}" role="tabpanel">
                    ...
                    {{-- Tab 2: Tiến độ --}}
                    <div class="tab-pane fade" id="tab-progress-sustainability-{{ $selectedDoc->id }}" role="tabpanel">
                    ...
                    <div class="tab-pane fade" id="tab-payment-sustainability-{{ $selectedDoc->id }}" role="tabpanel">
                        <livewire:admin.contracts.contract-payment-schedule-manager
                            :contractType="'sustainability'"
                            :contractId="$selectedDoc->id"
                            :key="'payment-sustainability-' . $selectedDoc->id"
                        />
                    </div>
                    @endunless
                    </div>
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" wire:model="formData.info_source" list="info-source-list-sustainability" placeholder="Nhập hoặc chọn nguồn...">
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-4">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="form_sus_renewal" wire:model="formData.is_renewal">
