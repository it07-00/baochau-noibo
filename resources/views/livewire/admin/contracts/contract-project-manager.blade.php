            ...
            <div class="modal-content overflow-hidden border-0 shadow-lg">
                ...
                <div class="modal-body p-0">
                    ...
                    <ul class="nav nav-tabs px-4 pt-3 bg-white" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link active fw-semibold" data-bs-toggle="tab" data-bs-target="#tab-info-project-{{ $selectedDoc->id }}" type="button">
                                <i class="bi bi-info-circle me-1"></i>Thông tin HĐ
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link fw-semibold" data-bs-toggle="tab" data-bs-target="#tab-progress-project-{{ $selectedDoc->id }}" type="button">
                    ...
                    {{-- Tab 1: Thông tin HĐ --}}
                    <div class="tab-pane fade show active" id="tab-info-project-{{ $selectedDoc->id }}" role="tabpanel">
                    ...
                    {{-- Tab 2: Tiến độ --}}
                    <div class="tab-pane fade" id="tab-progress-project-{{ $selectedDoc->id }}" role="tabpanel">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" wire:model="formData.info_source" list="info-source-list-project" placeholder="Nhập hoặc chọn nguồn...">
                        ...
                        <div class="col-md-12 d-flex gap-4 pt-1">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="form_pj_renewal" wire:model="formData.is_renewal">
