        ...
        <div class="table-responsive mh-350" >
            <table class="table table-hover align-middle mb-0 table-xs">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ (auth()->user()->hasAnyRole([\App\Enums\Role::TU_VAN->value, \App\Enums\Role::KY_THUAT->value])? 5: 8) + ($canBulkDelete ? 1 : 0) }}"
                ...
                <div class="modal-body p-0">
                    @if ($selectedDoc)
                        ...
                        <div class="tab-content">
                            {{-- Tab 1: Thông tin HĐ --}}
                            <div class="tab-pane" :class="{ 'show active': tab === 'info' }" id="tab-info-project-{{ $selectedDoc->id }}"
                                role="tabpanel">
                            ...
                            {{-- Tab 2: Tiến độ --}}
                            <div wire:ignore wire:key="progress-tab-project-{{ $selectedDoc->id }}" class="tab-pane" :class="{ 'show active': tab === 'progress' }" id="tab-progress-project-{{ $selectedDoc->id }}"
                                role="tabpanel">
                            ...
                            <div class="tab-pane" :class="{ 'show active': tab === 'docs' }" id="tab-docs-project-{{ $selectedDoc->id }}" role="tabpanel">
                                <div class="p-3">
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body p-0">
                    @if ($workflowContractId)
                        <div wire:ignore wire:key="wf-panel-project-{{ $workflowContractId }}">
