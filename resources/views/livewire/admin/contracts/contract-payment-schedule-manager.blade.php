<div class="border-top mt-3">
    ...
    <div class="px-4 py-2 bg-white border-bottom">
        ...
        <div class="d-flex justify-content-between small mb-1">
            ...
            <span>Còn lại: <strong class="text-danger">{{ number_format($totalAmount - $totalPaid) }}đ</strong></span>
        </div>
        ...
        <table class="table table-sm table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        @if($s->due_date)
                            <span class="{{ $s->status !== 'paid' && $s->due_date->isPast() ? 'text-danger fw-bold' : '' }}">
                    ...
                    <td class="text-center pe-4">
                        <div class="d-flex justify-content-center gap-1">
                            @if($s->status !== 'paid')
                            <button class="btn btn-sm p-0 text-success" wire:click="markPaid({{ $s->id }})" title="Đã thanh toán"
                                    wire:confirm="Đánh dấu đợt này đã thanh toán đủ?">
                                <i class="bi bi-check-circle fs-6"></i>
                            </button>
                            @endif
                            <button class="btn btn-sm p-0 text-warning" wire:click="edit({{ $s->id }})" title="Sửa">
    ...
    <div class="border-top p-4 bg-light">
        ...
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-sm @error('form.installment_name') is-invalid @enderror"
                       wire:model="form.installment_name" placeholder="VD: Đợt 1, Tạm ứng...">
                @error('form.installment_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
            <div class="col-md-2">
                <label class="form-label fw-semibold small">Tỉ lệ (%)</label>
                <input type="number" class="form-control form-control-sm" wire:model="form.percentage" min="0" max="100" step="0.01">
            </div>
            <div class="col-md-3">
                <label class="form-label fw-semibold small">Số tiền (đ) <span class="text-danger">*</span></label>
                <input type="text" class="form-control form-control-sm money-input @error('form.amount') is-invalid @enderror"
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control form-control-sm money-input" wire:model="form.paid_amount" placeholder="0">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control form-control-sm" wire:model="form.notes" placeholder="Ghi chú...">
            </div>
