                ...
                <div class="d-flex align-items-center flex-grow-1">
                    <div class="d-flex flex-column align-items-center flex-shrink-0" style="width: 76px;">
                        ...
                        <span class="text-center"
                            style="font-size: 0.72rem; line-height: 1.3; width: 76px; word-break: break-word;
                    ...
                    @if (!$loop->last)
                        <div class="flex-grow-1"
                            style="height: 2px; margin-top: -26px; min-width: 8px;
            ...
            <div wire:key="confirm-{{ $activeStep }}" class="card border border-primary shadow-sm mt-3">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea wire:model="comment" class="form-control" rows="2" placeholder="Nhập ghi chú cho bước này..."></textarea>
                    </div>
