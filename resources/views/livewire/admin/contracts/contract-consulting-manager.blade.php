<div class="contract-manager-page">
    ...
    @include('livewire.admin.contracts.partials.contract-page-header', [
        ...
        'createPermission' => 'contracts-consulting.create',
    ])
    {{--
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Hồ sơ môi trường</li>
                </ol>
            </nav>
        </div>
        <div class="d-flex gap-2 ms-auto justify-content-end">
            @can('contracts-consulting.create')
                                    ...
                                    <div class="d-md-none">
                                        <div x-show="!editing" class="d-flex align-items-center justify-content-center gap-1">
                                            ...
                                            <button @click="editing = true; $nextTick(() => $refs.reportInput.focus())"
                                                ...
                                                <i class="fa-solid fa-pen-square fs-72" ></i>
                                            </button>
                                        </div>
                                ...
                                <td class="text-center">
                                    @if($this->deadlineMeta($doc)['deadline'])
                                        @if($this->deadlineMeta($doc)['isFinished'])
                                            ...
                                            <br><span class="badge bg-success contract-text-08" ><i class="fa-solid fa-circle-check me-1"></i>Hoàn thành</span>
                                        @elseif($this->deadlineMeta($doc)['isOverdue'])
                                            ...
                                            <br><span class="badge bg-danger contract-text-08" ><i class="fa-solid fa-triangle-exclamation me-1"></i>Quá hạn {{ abs($this->deadlineMeta($doc)['daysLeft']) }} ngày</span>
                                        @elseif($this->deadlineMeta($doc)['isDueToday'])
                                            <span class="fw-bold text-danger contract-text-08" >{{ $this->deadlineMeta($doc)['deadline']->format('d/m/Y') }}</span>
                                            <br><span class="badge bg-warning text-dark contract-text-08" ><i class="fa-solid fa-circle-exclamation me-1"></i>Đến hạn hôm nay</span>
                                        @elseif($this->deadlineMeta($doc)['isNearDue'])
                                            ...
                                            <br><span class="badge bg-warning text-dark contract-text-08" ><i class="fa-solid fa-clock me-1"></i>Còn {{ $this->deadlineMeta($doc)['daysLeft'] }} ngày</span>
                                        @else
                                            <span class="fw-semibold text-success contract-text-08" >{{ $this->deadlineMeta($doc)['deadline']->format('d/m/Y') }}</span>
                                ...
                                <table class="table table-bordered mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge bg-{{ $selectedDoc->status_color }}">{{ $selectedDoc->status_label }}</span>
                                            </td>
                                        </tr>
                                        <tr>
