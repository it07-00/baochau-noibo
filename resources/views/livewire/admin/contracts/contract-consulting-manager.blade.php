                    ...
                    @if ($selectedDoc)
                        ...
                        <ul class="nav nav-tabs px-4 pt-3 bg-white" role="tablist">
                            ...
                            @unless (auth()->user()->hasAnyRole(['tu-van', 'ky-thuat']))
                                <li class="nav-item">
                                    <button class="nav-link fw-semibold" data-bs-toggle="tab"
                                        data-bs-target="#tab-payment-consulting-{{ $selectedDoc->id }}" type="button">
                        ...
                        <div class="tab-content">
                            ...
                            @unless (auth()->user()->hasAnyRole(['tu-van', 'ky-thuat']))
                                ...
                                <div class="tab-pane fade" id="tab-payment-consulting-{{ $selectedDoc->id }}"
                                    role="tabpanel">
                                    <livewire:admin.contracts.contract-payment-schedule-manager :contractType="'consulting'"
                                        :contractId="$selectedDoc->id" :key="'payment-consulting-' . $selectedDoc->id" />
                                </div>
                            @endunless
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" wire:model="formData.info_source"
                                list="info-source-list-consulting" placeholder="Nhập hoặc chọn nguồn...">
