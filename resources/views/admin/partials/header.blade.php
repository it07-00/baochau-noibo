        ...
        <div class="col-xl-5 col-lg-5 col-md-4 col-sm-5 col-6">
            <ul class="navbar-nav flex-row align-items-center justify-content-end">
                ...
                <li class="header-nav-item me-4 position-relative">
                    ...
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="margin-top: 5px; margin-left: -5px;">3</span>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg py-0">
                        <div class="dropdown-header d-flex align-items-center justify-content-between border-bottom py-3">
                            ...
                            <span class="badge bg-danger rounded-pill">3 mới</span>
                        </div>
                        <div class="dropdown-body py-2">
                            <a class="dropdown-item" href="javascript:void(0);">Bạn có đơn hàng mới</a>
                            <a class="dropdown-item" href="javascript:void(0);">Người dùng vừa cập nhật hồ sơ</a>
                            <a class="dropdown-item" href="javascript:void(0);">Sao lưu hệ thống hoàn tất</a>
                        </div>
                    </div>
                </li>
