                ...
                <div class="card border border-secondary-subtle rounded-3 shadow-sm bg-body position-sticky" style="top: 80px;">
                    <div class="card-header bg-body-tertiary border-bottom p-3">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <span class="small text-muted">Khai báo mã vai trò và gán quyền</span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body p-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control bg-body-tertiary border-secondary-subtle fw-bold text-primary @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="Ví dụ: kinh-doanh, ke-toan-vien">
                            @error('name')
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary fw-bold py-2 rounded-3 shadow-sm">
                                <i class="fa-solid fa-floppy-disk me-1.5"></i>Tạo mới vai trò
                            </button>
