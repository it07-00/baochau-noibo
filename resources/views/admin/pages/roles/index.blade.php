        ...
        <div class="col-12">
            <div class="pure-card rounded-custom card-bg shadow-custom">
                <div class="pure-card-header d-flex align-items-center justify-content-between gap-3">
                    ...
                    <a href="{{ route('app.roles.create') }}" class="btn btn-primary btn-sm">Tạo vai trò mới</a>
                </div>
                        ...
                        <table class="table text-nowrap align-middle table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('app.roles.edit', $role) }}" class="btn btn-sm btn-icon btn-light text-primary rounded-pill me-1" title="Sửa">
                                            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                            </svg>
                                        </a>
                                        <form action="{{ route('app.roles.destroy', $role) }}" method="POST" class="d-inline-block" onsubmit="return confirm('Xóa vai trò này sẽ ảnh hưởng đến nhân viên. Bạn có chắc chắn?');">
                                            @csrf
                                            @method('DELETE')
