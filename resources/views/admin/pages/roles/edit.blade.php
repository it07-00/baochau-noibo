                ...
                <div class="card border border-secondary-subtle rounded-3 shadow-sm bg-body position-sticky" style="top: 80px;">
                    ...
                    <div class="card-body p-3.5">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg bg-body-tertiary border-secondary-subtle fw-bold fs-6 text-primary @error('name') is-invalid @enderror" value="{{ old('name', $role->name) }}" required placeholder="Ví dụ: kinh-doanh, ke-toan-vien">
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text text-muted small mt-2">
                                <i class="fa-solid fa-circle-info me-1 text-primary"></i>Tên mã định danh phân quyền. Hệ thống tự động lưu dưới dạng chữ thường.
                            </div>
                        </div>
                    ...
                    <div class="card-body p-3.5">
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-3 flex-wrap">
                            <div>
                                ...
                                <p class="text-muted small mb-0">Bật/tắt các quyền truy cập để thiết lập phạm vi thao tác cho vai trò này.</p>
                            </div>
