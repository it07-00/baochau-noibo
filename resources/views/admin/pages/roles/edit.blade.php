                    ...
                    <div class="card-body p-3.5">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name"
                                ...
                                placeholder="Ví dụ: kinh-doanh, ke-toan-vien">
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text text-muted small mt-2">
                                <i class="fa-solid fa-circle-info me-1 text-primary"></i>Tên mã định danh phân quyền. Hệ
                                thống tự động lưu dưới dạng chữ thường.
                            </div>
                        </div>
