    ...
    <div class="min-vh-100 row justify-content-center my-auto g-0 bg-error-page">
        <div class="col-xl-9 col-md-10 col-11 my-auto">
            <div class="px-5 py-14 error-img text-center rounded">
                ...
                <div class="mb-4">
                    <svg class="mw-100" width="380" height="140" viewBox="0 0 380 140" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Error 400">
                        <text x="20" y="110" font-size="120" font-weight="700" fill="#C1B9FF">400</text>
                    </svg>
                </div>

                <h2 class="display-7 fw-semibold text-uppercase">Bad Request</h2>
                <p class="lead mb-7">Yeu cau khong hop le. Vui long kiem tra du lieu va thu lai.</p>
