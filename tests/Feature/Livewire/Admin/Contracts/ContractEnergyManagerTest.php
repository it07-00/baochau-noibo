...
class ContractEnergyManagerTest extends TestCase
{
    ...
    public function test_can_render_component_and_list_contracts(): void
    {
        ...
        Livewire::test(ContractEnergyManager::class)
            ->assertStatus(200)
            ->assertSee($this->customer->name)
            ->assertSee('50,000,000');
    }

    public function test_assigned_consultant_can_open_energy_workflow_from_contract_list(): void
    {
        $consultingRole = Role::findByName(RoleEnum::TU_VAN->value);
        $consultingRole->syncPermissions([PermissionEnum::CONTRACTS_ENERGY_VIEW->value]);
