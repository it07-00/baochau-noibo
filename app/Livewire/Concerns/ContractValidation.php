...
trait ContractValidation
{
    ...
    protected function baseContractRules(): array
    {
        return [
            ...
            'formData.payment_percentage' => 'nullable|numeric|min:0|max:100',
            'formData.service_content' => 'nullable|string|max:2000',
            'formData.submission_place' => 'nullable|string|max:500',
