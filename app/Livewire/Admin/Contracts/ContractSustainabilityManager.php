...
class ContractSustainabilityManager extends Component
{
    ...
    {
        $this->selectedDoc = ContractSustainability::with(['customer', 'staff', 'department'])->find($id);
        if ($this->selectedDoc) {
    ...
    public function render()
    {
        ...
        return view('livewire.admin.contracts.contract-sustainability-manager', [
            ...
            'provinces'          => ContractSustainability::whereNotNull('province')->where('province', '!=', '')->distinct()->pluck('province')->toArray(),
