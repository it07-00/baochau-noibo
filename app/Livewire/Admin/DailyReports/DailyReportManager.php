...
class DailyReportManager extends Component
{
    ...
    public function mount($userId = null)
    {
        ...
        $this->isManager = auth()->user()->hasRole('Director') || auth()->user()->hasRole('Sales Manager');
        if (!$this->isManager) {
    ...
    public function render()
    {
        ...
        if ($this->isManager || $this->activeTab === 'history') {
            if ($this->isManager && $this->viewType === 'day') {
                ...
                $monthReports = DailyReport::whereIn('user_id', $userIds)
